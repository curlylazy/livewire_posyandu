...
<div>
    <footer id="footer" class="footer dark-background">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-3 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right"></i> <a href="{{ url('berita') }}">Berita</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a href="{{ url('galeri') }}">Galeri</a></li>
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">{{ config('app.webname') }}</strong> <span>All Rights Reserved</span></p>
            <div class="credits">

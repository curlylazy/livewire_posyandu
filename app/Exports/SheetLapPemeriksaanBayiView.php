...
class SheetLapPemeriksaanBayiView implements FromView, WithTitle, WithColumnFormatting, WithEvents
{
    protected $data;
    protected $bulan;
    protected $tahun;
    ...
    {
        return view('exports.sheet_pemeriksaan_bayi', [
            'dataRows' => $this->data,
            'kategori_periksa' => $this->kategori_periksa,
            'bulan' => $this->bulan,
            'tahun' => $this->tahun,
            'page_title' => "Laporan Pemeriksaan Bayi",
        ]);
    }
